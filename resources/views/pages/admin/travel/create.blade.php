...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800" style="font-weight: bold">Tambah Jadwal Travel</h1>
    </div>
        ...
        <div class="card-body">
            <form action="{{ route('travel.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="time" class="form-control" name="waktu" placeholder="Waktu Keberangkatan" value="{{ old('waktu') }}">
                </div>
                <div class="form-group">
                    <label for="kuota">Kuota</label>
                    <input type="number" class="form-control" name="kuota" placeholder="Kuota Penumpang" value="{{ old('kuota') }}">
                </div>
                <div class="form-group">
